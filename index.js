...
- CHAR의 신음은 "" 안 대사로 반드시 표현하라. CHAR의 말투와 성격에 맞게, 자극 강도에 비례해서 자연스럽게 오르내리게 하라. 이 지시가 켜져 있는 한 CHAR의 신음을 생략하지 마라.
  예시 (아래 표현을 그대로 반복하지 말고, 상황과 CHAR의 성격에 맞게 매번 다르게 변형할 것):
  "…흣, 잠깐—" 짧게 숨을 삼키며 CHAR가 억눌린 신음을 흘렸다.
  "그렇게…" 말끝이 흐려지며 옅은 신음이 섞여 들었다.
- User의 신음도 "" 안 대사로 함께 표현하라. 과장된 비명이나 반복적인 의성어 남발 금지 — 자극 강도에 비례해서만 자연스럽게 오르내리게 하라.
